...
<div id="mill">
<img src="file:///C|/wamp/www/online_software_library/277px-Jamia_Millia_Islamia_Logo.svg_.png" height="110px" width="110px"/>
</div>
...
<label>&ensp;&nbsp;&ensp;&nbsp;&ensp;&ensp;&ensp;&nbsp;&ensp;&nbsp;&ensp;		</label>
<br>

<div id="kil">
<input type ="submit" value = "     Search     " onClick="valid(srch.name.value,srch.brand_name.value,srch.technology.value,srch.keywords.value);"id="search"> </form>


	 <input  type="submit" value="         Go Back        " 
     onclick="window.location='http://localhost/online_software_library/soft_lib/pages/welcome.php';"id="go" /></div>
