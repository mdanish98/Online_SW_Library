...
<input name= "am" type="button" value="              Members          "  
	 onclick="window.location='http://localhost/online_software_library/soft_lib/pages/rosmam.php';" id="mem1"> <br><br>
<input name ="rm" type="button" value="             Products            "
	 onclick="window.location='http://localhost/online_software_library/soft_lib/pages/rosof.php';" id="pro1"><br><br>


<input  type="submit" value="             Main Menu            " 
     onclick="window.location='http://localhost/online_software_library/soft_lib/pages/jadm.php';" id="main1" /> 
