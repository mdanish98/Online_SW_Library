...
var JQuerySlider4_slider = null;	

xtd_jQuery(document).ready(function(){
	var $ = xtd_jQuery;
	var jQuery = xtd_jQuery;
	
	$("#JQuerySlider4Container").hide();
	...
	function createJQuerySlider() {
		...
		$("#JQuerySlider4Container").show();
		
		// create the slider
		JQuerySlider4_slider = $("#JQuerySlider4").jQuerySlider();
	}
});